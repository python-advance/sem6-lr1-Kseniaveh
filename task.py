...
"""
    Какое самое популярное мужское имя на параходе?
    Какое самое популярное женское имя на параходе?
    Какое самое популярное мужское имя на параходе старше 15 лет?
    Какое самое популярное женское имя на параходе старше 15 лет?
    Какое самое популярное имя среди всех на параходе старше 15 лет?
"""
def get_name(name):
    import re
